...
const Dashboard = () => {
  ...
  const menuButtonClass = menuOpen
    ? "menu-button"
        ...
        <div className="dashboard-content">
          ...
          >
            <div className="general-analysis">
              <button onClick={toggleMenu} className={menuButtonClass}>
                Eventos do mês
                  ...
                  <div className="sugestions">
                    ...
                    <div className="suggestion">
                      ...
                      <p>
                        ...
                        pré-evento, explorando diferentes canais de comunicação
                        e plataformas online para alcançar um público mais
                        amplo. Isso poderia aumentar a participação e garantir
                        que o evento alcance seu potencial máximo de
                        engajamento.
                      </p>
                    </div>
                  </div>
