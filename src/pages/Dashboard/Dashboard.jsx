...
import { Sidebar, Navbar, TicketsCard, Qrcode } from "../../pages/index";
      ...
      <div className="dashboard-container-main">
        <div className="left-column-dashboard">
          <div className="general-analysis">
            <button onClick={toggleMenu}>Abrir/Fechar Menu</button>
                ...
                <div className="sugestions">
                  <div className="suggestion">
                    ...
                    <p>
                      ...
                      convidados, incluindo vozes de diferentes origens e áreas
                      de especialização. Isso poderia enriquecer ainda mais o
                      conteúdo do evento e oferecer perspectivas variadas sobre
                      os temas abordados.
                    </p>
                  </div>
                  ...
                  <div className="suggestion">
                    ...
                    <p>
                      ...
                      explorando diferentes canais de comunicação e plataformas
                      online para alcançar um público mais amplo. Isso poderia
                      aumentar a participação e garantir que o evento alcance
                      seu potencial máximo de engajamento.
                    </p>
                  </div>
                </div>
              </div>
